...
//
// Define types of TPMs (buses, vendors)
//
#define TIS_DEVICE_TYPE_LPC 		((UINTN) 0x01)
#define TIS_DEVICE_TYPE_I2C_ATMEL 	((UINTN) 0x02)
...
typedef TIS_TPM_DEVICE *TIS_TPM_DEVICE_PTR;
